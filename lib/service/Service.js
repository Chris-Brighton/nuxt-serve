...
module.exports = class Service {
  ...
  configure(app) {
    ...
    if (this.model) {
      ...
      app.post(`/${this.name}`, handler.create(model))
      app.get(`/${this.name}/:id`, handler.get(model))
      app.get(`/${this.name}`, handler.find(model))
      app.delete(`/${this.name}/:id`, handler.remove(model))
      app.put(`/${this.name}/:id`, handler.update(model))
    }
